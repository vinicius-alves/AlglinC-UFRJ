...
function_X = lambda x: (1/(np.sqrt((1-(x/1.0)**2)**2+(2*0.05*(x/1.0))**2)))**2*(((4*np.pi**3*9.0)/(x**5*5.0**4))*np.exp((-16*np.pi**3)/(x**4*5.0**4))), 0.0, 10.0
function_X2 = lambda x: x**2*(1/(np.sqrt((1-(x/1.0)**2)**2+(2*0.05*(x/1.0))**2)))**2*(((4*np.pi**3*9.0)/(x**5*5.0**4))*np.exp((-16*np.pi**3)/(x**4*5.0**4))), 0.0, 10.0

print my_lib.quadratura_Gauss(function_X)
print my_lib.quadratura_Gauss(function_X2)
print ""
